...
function DashBoard() {
    return (
        <>
            <div className="col-xxl-9 col-lg-8 w-[960px] h-[800px] pl-5 bg-slate-200 ml-4">
                ...
                <div className="dashboard-right-sidebar ">
                    ...
                    <div className="row flex">
                        <div className=" col-xxl-6 w-[480px] h-[auto]  flex relative px-5 ">
                        ...
                        <div className="col-xxl-6 w-[480px] h-[auto]  flex relative px-5">
                            <div className="order-tab w-[420px] h-[auto] relative  mt-3 ">
