                ...
                <div className=" w-[879px] h-[auto] px-[22px]    rounded-md">
                    ...
                    <div className="row flex  ">
                        <div className="  col-xxl-6  flex relative   ">
                            <div className=" relative   w-[840px] h-[530px] bg-white">
                                        ...
                                        <table className="w-full table">
                                            ...
                                            <tbody>
                                                ...
                                                <tr className="text-center table-row align-middle whitespace-nowrap flex items-center">
                                                    ...
                                                    <td className="w-[90px] h-[72px] border border-solid border-inherit border-0">
                                                        <h6 className="text-green-700 font-bold ">150.000₫</h6>
                                                    </td>
                                                    <td className="w-[90px] h-[72px] border border-solid border-inherit border-0">
                                                        <h6>832</h6>
                                                    </td>
                                                    ...
                                                    <td className="w-[90px] h-[72px] border border-solid border-inherit border-0">
                                                        <button className="py-1">
                                                            <i className="fa-solid fa-pen-to-square  w-[19px] stroke-1  text-green-500"></i>
                                                ...
                                                <tr className="text-center table-row align-middle whitespace-nowrap flex items-center">
                                                    ...
                                                    <td className="w-16 h-16 border border-solid border-inherit border-0">
                                                        <h6 className="text-green-700 font-bold ">50.000₫</h6>
                                                    </td>
                                                    <td className="w-16 h-16 border border-solid border-inherit border-0">
                                                        <h6>332</h6>
                                                    </td>
                                                ...
                                                <tr className="text-center table-row align-middle whitespace-nowrap flex items-center">
                                                    ...
                                                    <td className="w-16 h-16 border border-solid border-inherit border-0">
                                                        <h6 className="text-green-700 font-bold ">60.000₫</h6>
                                                    </td>
                                                    <td className="w-16 h-16 border border-solid border-inherit border-0">
                                                        <h6>500</h6>
                                                    </td>
                                                ...
                                                <tr className="text-center table-row align-middle whitespace-nowrap flex items-center">
                                                    ...
                                                    <td className="w-16 h-16 border border-solid border-inherit border-0">
                                                        <h6 className="text-green-700 font-bold ">40.000₫</h6>
                                                    </td>
                                                    <td className="w-16 h-16 border border-solid border-inherit border-0">
                                                        <h6>1200</h6>
                                                    </td>
                                                ...
                                                <tr className="text-center table-row align-middle whitespace-nowrap flex items-center">
                                                    ...
                                                    <td className="w-[90px] h-[72px]">
                                                        <h6 className="text-green-700 font-bold ">54.000₫</h6>
                                                    </td>
                                                    <td className="w-[90px] h-[72px]">
                                                        <h6>2123</h6>
                                                    </td>
