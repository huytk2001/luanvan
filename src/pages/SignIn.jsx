            ...
            <section>
                <div className=" w-[100%] h-[50px] bg-slate-200">
                    <div className="w-[1280px] h-full m-auto flex justify-between items-center  text-textDark">
                        ...
                        <div className="z-10 "><h2>Đăng ký</h2></div>
                            ...
                            <div className='right  bg-gray-200 px-3'>
                                <div className="log-in-box px-5 py-5">
                                    <div className="log-in-title mb-2">
                                        ...
                                        <h4 className='leading-6 m-0 font-normal text-18 mt-2'>Đăng ký  tài khoản </h4>
                                    </div>
                                    <div className="input-box">
                                        <form>
                                            <div className="from-floating relative mt-4">
                                                <input type="text" className="w-full h-[50px] px-3 border" id="fname" placeholder='' required />
                                                <label className="absolute top-1/2 left-3 -translate-y-1/2 bg-white px-1 text-gray-500 pointer-events-none" htmlFor='fname'>Họ và tên</label>
                                            </div>
                                            <div className="from-floating relative mt-4">
                                            ...
                                            <div className='forgot-box mt-4 flex items-center justify-between'>
                                                <div className="rm flex items-center ">
                                                    ...
                                                    <label className='form-check-label ml-2' htmlFor='CheckDefault'>Tôi đồng ý với Điều khoản và Quyền riêng tư</label>
                                                </div>
                                    ...
                                    <div className='other-sign-up mt-10 text-center'>
                                        <h4 className='text-gray-700 leading-6 m-0 font-normal font-light mb-2 text-sm'>Đã có tài khoản rồi?</h4>
                                        <a href=" " className='text-green-500 text-sm'>Đăng nhập</a>
                                    </div>
